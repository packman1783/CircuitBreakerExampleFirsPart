...
Цель проекта: Предотвращение каскадных сбоев в системе при недоступности внешнего сервиса.
...
/api/data	Возвращает реальные данные  
/api/fail	Возвращает 500 ошибку  
